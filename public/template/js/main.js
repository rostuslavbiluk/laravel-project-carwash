...
$(function () {
  ...
  //$('input.single-daterange').daterangepicker({ "singleDatePicker": true, dateFormat: "yy-mm-dd" });
  //$('input.multi-daterange').daterangepicker({"dateFormat": "yy-mm-dd", "startDate": "03/28/2018", "endDate": "04/06/2018" });
